...
# или же ====>
print(my_dict.get('Max', 'Такого ключа нет, в Вашем словаре нет'))
my_dict.update({'Katrin' : 1987,
                'Roman' : 1982}) # - Добавьте ещё две произвольные пары того же формата в словарь
print(my_dict)
del my_dict['Katrin'] # - Удалите одну из пар в словаре по существующему ключу из словаря
print(my_dict)
# --------РАбота с множество--------
...
print(my_set)
print(my_set.pop()) # - Удалите один любой элемент из множества
print(my_set)
